...
public class Programm {
    public static void main(String[] args) {
        ...
        Torwart loeffel = new Torwart("Löffel",30,7, 5,8);
        ...
        Mannschaft mannschaftBremen = new Mannschaft("Bremen", gabel, loeffel, spielerListeNoobies);

        Ergebnis ergebnis = new Ergebnis();

        Spiel championsLeague = new Spiel(mannschaftBayern,mannschaftBremen);
